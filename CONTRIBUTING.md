...
`cloud-itonami-iso3166-jpn-digital` accepts contributions to the OSS actor, governor tests,
...
- Keep production actions behind the Digital Procurement Compliance Governor.
- Never let the advisor state a legal/tax conclusion as fact — every
  regulatory requirement must cite the official Digital Agency source.
