(ns digitalprocurement.phase
  "Phase 0->3 staged rollout for the JPN-DIGITAL (Digital Agency)
  compliance actor.
  ...
  set'). Drafting a real gBizID/Gov-Cloud filing package and submitting
  a real gBizID application / Gov-Cloud catalog application are the
  two real-world acts this actor performs; both are always a human
  operator's call. `digitalprocurement.governor`'s
...
(defn verdict->disposition
  "Map a Digital Procurement Compliance Governor verdict to a base
